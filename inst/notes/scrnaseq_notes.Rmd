...
# The only assumption we need to interpret sample heterogeneity in an RLE plot as a sign of unwanted variation is that expression levels of a majority of genes are unaffected by the biological factors of interest. We noted, however, that while this assumption is often plausible, it is sometimes not safe to make, and sometimes not even needed
```
...
# For more on how to deal with negative size factors, refer to the 
# "Dealing with negative size factors" section of ?computeSumFactors

# nice!
# I think I get what's going on here

# THIS IS A WONDERFUL APPROACH, AND THE ACCOMPANYING PAPER (Lun 2016) DESCRIBES EVERYTHING PERFECTLY!!!
```
...
# THIS produces nice plots, but NOT when you use umi.qc$batch
# why???
```
...
Look at this - https://www.stephaniehicks.com/2018-bioinfosummer-scrnaseq/cleaning-the-expression-matrix.html#dealing-with-confounders
```{r}
...
From - https://www.stephaniehicks.com/2018-bioinfosummer-scrnaseq/biological-analysis.html#differential-expression-de-analysis
