...
To launch a presentation for a particular class (e.g. class 1), run the following 
``` r
...
```
To launch the homework R Markdown files, use the function `launch_homework()` (which works just like `launch_class()`)
